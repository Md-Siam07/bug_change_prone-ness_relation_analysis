...
for project_dir in project_dirs:
    ...
    output_dir = f"/home/mdsiam/Desktop/extension/change-defect-relation-analysis/Code/changes_stable/{project}"
    ...
    for index, row in df.iterrows():
        ...
        if index == 0:
            ...
            last_stable_version = df.iloc[index - 1]["revision.id.fixed"]
